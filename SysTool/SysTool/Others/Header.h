...
#define HSCREEN ([UIScreen mainScreen].bounds.size.height>740?667:[UIScreen mainScreen].bounds.size.height)
#define HSCREENX [UIScreen mainScreen].bounds.size.height
#define BSCREEN [UIScreen mainScreen].bounds

#define statesHeight (HSCREENX>740?20:0)
...
//#define GGADID @"ca-app-pub-3940256099942544/1712485313" //测试id
#define GGADID @"ca-app-pub-3133793130405977~7784296532"  //上线id
